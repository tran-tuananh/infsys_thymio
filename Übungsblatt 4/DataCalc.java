...
public class DataCalc {
	...
	private void discreteValues(String id, String dataLeft, String dataRight) {
		...
		/*
		 * Thymio wurde w‰hrend der Messung bewegt - grˆﬂere Streuung der Werte;
		 * Minima bei Kante: sehr klein, weil Sensoren zu schwach und liefern in
		 * einem sehr kleinen Winkel Werte f¸r alle drei Frontsensoren In den
		 * meisten F‰llen ist nur der Frontale und eins von
